			...
			<div class="form-group">
				...
				<div class="col-lg-3">
					{assign var='fieldName' value='Legal_Constant::MODVAR_MINIMUM_AGE'|constant}
						<input id="legal_{$fieldName}"{if isset($errorFields.legal_minage)} class="form-control z-form-error"{else} class="form-control"{/if} type="text" name="{'Legal_Constant::MODVAR_MINIMUM_AGE'|constant}" value="{$modvars.Legal.$fieldName|safetext}" size="2" maxlength="2" />
