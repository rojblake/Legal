	...
	<div>
		...
		<fieldset>
			...
			<div class="form-group">
				...
				<label class="col-lg-3 control-label" for="legal_{$fieldName}">{gt text="Legal notice"}</label>
				<div class="col-lg-9">
					<input id="legal_{$fieldName}" class="form-control" name="{$fieldName}" type="text" value="{$modvars.Legal.$fieldName}" />
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-lg-3">
					{assign var='fieldName' value='Zikula\LegalModule\Constant::MODVAR_MINIMUM_AGE'|constant}
						<input id="legal_{$fieldName}"{if isset($errorFields.legal_minage)} class="form-control z-form-error"{else} class="form-control"{/if} type="text" name="{'Zikula\LegalModule\Constant::MODVAR_MINIMUM_AGE'|constant}" value="{$modvars.Legal.$fieldName|safetext}" size="2" maxlength="2" />
		...
		<div class="form-group">
			<div class="col-lg-offset-3 col-lg-9">
				...
				<a class="btn btn-danger" href="{modurl modname='Legal' type='admin' func='main'}" title="{gt text="Cancel"}">{gt text="Cancel"}</a>
			</div>
		</div>
	</div>
    </form>
